...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click'); // tabs('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click');
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); //  блок сообщения 

      var statusMessage = document.createElement('div');
      statusMessage.classList.add('status');
      item.appendChild(statusMessage); // сбор данных
...
var modals = function modals() {
  ...
  showModals('.phone_link', '.popup', '.popup .popup_close'); // showModalsByTime('.popup', 3000);
};
